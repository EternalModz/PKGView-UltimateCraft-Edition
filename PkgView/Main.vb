...
Public Class Main
    ...
    Private Sub AssociatePKGFilesWithThisApplicationToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub View1ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles View1ToolStripMenuItem.Click
        lista.View = View.LargeIcon
    End Sub

    Private Sub View2ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles View2ToolStripMenuItem.Click
        lista.View = View.SmallIcon
    End Sub

    Private Sub View3ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles View3ToolStripMenuItem.Click
        lista.View = View.List
    End Sub

    Private Sub View4ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles View4ToolStripMenuItem.Click
        lista.View = View.Details
    End Sub

    Private Sub SetPKGStudioToOpenAllPKGFilesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SetPKGStudioToOpenAllPKGFilesToolStripMenuItem.Click
        UtilRegistry.DesasociarExtension(".PKG")
        UtilRegistry.AsociarExtension(".PKG", Application.ExecutablePath, "PS3 Installation file", "open", "PS3 Installation", Application.ExecutablePath & ",1")
        UtilRegistry.AsociarExtension(".PKG", Application.ExecutablePath, "-ex ", "PS3 Installation file", "Extract PS3 PKG here...", "Extract here", Application.ExecutablePath & ",1")
    End Sub
